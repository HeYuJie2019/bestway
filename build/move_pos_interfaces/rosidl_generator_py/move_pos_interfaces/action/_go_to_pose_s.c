...
bool move_pos_interfaces__action__go_to_pose__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_Goal", full_classname_dest, 52) == 0);
  }
  move_pos_interfaces__action__GoToPose_Goal * ros_message = _ros_message;
  {  // target_x
...
PyObject * move_pos_interfaces__action__go_to_pose__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("move_pos_interfaces.action._go_to_pose");
...
ROSIDL_GENERATOR_C_EXPORT
bool move_pos_interfaces__action__go_to_pose__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_Result", full_classname_dest, 54) == 0);
  }
  move_pos_interfaces__action__GoToPose_Result * ros_message = _ros_message;
  {  // success
...
ROSIDL_GENERATOR_C_EXPORT
bool move_pos_interfaces__action__go_to_pose__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_Feedback", full_classname_dest, 56) == 0);
  }
  move_pos_interfaces__action__GoToPose_Feedback * ros_message = _ros_message;
...
ROSIDL_GENERATOR_C_EXPORT
bool move_pos_interfaces__action__go_to_pose__send_goal__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_SendGoal_Request", full_classname_dest, 64) == 0);
  }
  move_pos_interfaces__action__GoToPose_SendGoal_Request * ros_message = _ros_message;
  {  // goal_id
  ...
  {  // goal
    ...
    if (!move_pos_interfaces__action__go_to_pose__goal__convert_from_py(field, &ros_message->goal)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * move_pos_interfaces__action__go_to_pose__send_goal__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // goal
    PyObject * field = NULL;
    field = move_pos_interfaces__action__go_to_pose__goal__convert_to_py(&ros_message->goal);
    if (!field) {
      return NULL;
    }
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool move_pos_interfaces__action__go_to_pose__send_goal__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_SendGoal_Response", full_classname_dest, 65) == 0);
  }
  move_pos_interfaces__action__GoToPose_SendGoal_Response * ros_message = _ros_message;
  {  // accepted
...
ROSIDL_GENERATOR_C_EXPORT
bool move_pos_interfaces__action__go_to_pose__get_result__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    char full_classname_dest[66];
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_GetResult_Request", full_classname_dest, 65) == 0);
  }
  move_pos_interfaces__action__GoToPose_GetResult_Request * ros_message = _ros_message;
  {  // goal_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "goal_id");
    if (!field) {
      return false;
...
ROSIDL_GENERATOR_C_EXPORT
bool move_pos_interfaces__action__go_to_pose__get_result__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_GetResult_Response", full_classname_dest, 66) == 0);
  }
  move_pos_interfaces__action__GoToPose_GetResult_Response * ros_message = _ros_message;
  {  // status
  ...
  {  // result
    ...
    if (!move_pos_interfaces__action__go_to_pose__result__convert_from_py(field, &ros_message->result)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * move_pos_interfaces__action__go_to_pose__get_result__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // result
    PyObject * field = NULL;
    field = move_pos_interfaces__action__go_to_pose__result__convert_to_py(&ros_message->result);
    if (!field) {
      return NULL;
    }
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool move_pos_interfaces__action__go_to_pose__feedback_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_pos_interfaces.action._go_to_pose.GoToPose_FeedbackMessage", full_classname_dest, 63) == 0);
  }
  move_pos_interfaces__action__GoToPose_FeedbackMessage * ros_message = _ros_message;
  {  // goal_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "goal_id");
    if (!field) {
      return false;
  ...
  {  // feedback
    ...
    if (!move_pos_interfaces__action__go_to_pose__feedback__convert_from_py(field, &ros_message->feedback)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * move_pos_interfaces__action__go_to_pose__feedback_message__convert_to_py(void * raw_ros_message)
{
  ...
  {  // feedback
    PyObject * field = NULL;
    field = move_pos_interfaces__action__go_to_pose__feedback__convert_to_py(&ros_message->feedback);
    if (!field) {
      return NULL;
    }
    {
